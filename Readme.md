...
* Наставник: [Лиза Позднякова](https://up.htmlacademy.ru/htmlcss/25/user/5608).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/329099-technomart-25) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
